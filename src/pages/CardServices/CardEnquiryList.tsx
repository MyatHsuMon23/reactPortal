...
export default function cardEnquiryList() {
    ...
    const columns: GridColDef[] = [
        {
            ...
            renderCell: (params) => {
                const onClick = (e: any) => {
                    e.stopPropagation();
                    MySwal.fire({
                        html: `Are you sure to close this card (${maskCard(params?.row?.CARDNUMBER)})?`,
                        icon: "warning",
                            ...
                            mutateAction(
                                ...
                                },
                                {
                                    onSuccess: (data) => {
                                        if (data?.status == 200) {
                                            MySwal.fire({
                                                title: "Card Close is Successful !",
                                                icon: "success",
                                                confirmButtonColor: theme.palette.primary.main,
