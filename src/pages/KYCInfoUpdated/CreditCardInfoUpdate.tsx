...
import CreditCardInfoUpdateForm from './CreditCardInfoUpdateForm';
...
export default function CreditCardInfoUpdate() {
    let date = new Date();
    ...
    const handleUpdate = async () => {
        ...
        await queryClient.invalidateQueries(['fetchCreditCardKYC']);
    ...
    return (
        <Box component="div" style={{ width: '100%', marginTop: '10px', position: 'relative' }}>
            <Box display={'flex'} justifyContent={'space-between'}>
                ...
                {checkControlsByRole(role, 'CreditKYCUpdateCreate') && (
                    <Button
                        variant='contained'
                        size='medium'
                        onClick={() => {
            ...
            <CustomSwipeableDrawer open={openDrawer} setOpenDrawer={setOpenDrawer}>
                <CreditCardInfoUpdateForm setOpenDrawer={setOpenDrawer} mode={mode} refetchAPI={() => handleUpdate()} />
