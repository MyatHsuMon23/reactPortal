...
import { GetDocPersonTypeList, MaritalTypeList, ProcessingModeList, genderList, addressType, CountryList, regionList, SurNameList, NewgenderList } from '@/utils/commonData';
...
const schema = yup
    ...
    .shape({
        ...
        CardNumber: yup.string()
            ...
            // .test('len', val => checkCreditCardValid(val).message, val => checkCreditCardValid(val).valid),
...
const CreditCardInfoUpdateForm: React.FC<Props> = ({ setOpenDrawer, mode = 'create', refetchAPI }) => {
    ...
    const { data, isLoading } = useQueryListData({
        queryKey: "fetchCreditCardKYCById",
            ...
            },
            {
                onSuccess: (data) => {
                    if (data?.status == 200) {
                        ...
                        setCardNo(customerData?.CardNumber);
    ...
    const handleButtons = () => {
        ...
        } else if (!isMaker && mode === "edit" && formFields?.Status === "Submitted") {
            return (
                <LoadingButtonComponent
            ...
            <form onSubmit={handleSubmit(onSubmit)} action='#'>
                ...
                <Box component="fieldset" sx={{
                    ...
                    <Grid container columnSpacing={2} alignItems={'center'} justifyContent={'space-between'}>
                        <Grid item xs={2} md={2} fontWeight={600} fontSize={14}>
                            <Typography variant='subtitle1' fontSize={14} >Account No</Typography>
                        </Grid>
                        <Grid item xs={4} md={4}>
                            <TextFieldBox
                                disabled={checkStatus()}
                                InputProps={true}
                                onSearch={onSearchByValue}
                        ...
                        <Grid item xs={2} md={2} fontWeight={600} fontSize={14}>
                            <Typography variant='subtitle1' fontSize={14} >Search By Card Number</Typography>
                        </Grid>
                        <Grid item xs={4} md={4}>
                            <TextFieldBox
                                disabled={checkStatus()}
                ...
                <Box component="fieldset" sx={{
                    ...
                    <Grid container columnSpacing={2} alignItems={'center'}>
                        <Grid item xs={2} md={2} fontWeight={600} fontSize={14}>
                            <Typography variant='subtitle1' fontSize={14} >Customer Id</Typography>
                        </Grid>
                        <Grid item xs={4} md={4}>
                            <TextFieldBox
                                disabled={true}
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >NRC</Typography>
                        </Grid>
                ...
                <Box component="fieldset" sx={{
                    ...
                    <Grid container columnSpacing={2} alignItems={'center'} fontWeight={600} fontSize={14}>
                        <Grid item xs={2} md={2}>
                            <Typography variant='subtitle1' fontSize={14} >SurName</Typography>
                        </Grid>
                        <Grid item xs={4} md={4}>
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >Gender</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >Mobile Phone</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                            <TextFieldBox
                                type="number"
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >Region</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >Country</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >City</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                            <TextFieldBox
                                disabled={checkStatus()}
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >Street</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                            <TextFieldBox
                                disabled={checkStatus()}
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >House No</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                            <TextFieldBox
                                disabled={checkStatus()}
                        ...
                        <Grid item xs={2} md={2} mt={3}>
                            <Typography variant='subtitle1' fontSize={14} >Address</Typography>
                        </Grid>
                        <Grid item xs={4} md={4} mt={3}>
                            <TextFieldBox
                                multiline={true}
...
export default CreditCardInfoUpdateForm;