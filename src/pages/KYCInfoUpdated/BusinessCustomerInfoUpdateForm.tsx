...
import { GetDocPersonTypeList, MaritalTypeList, ProcessingModeList, genderList, addressType, regionList, NewgenderList, SurNameList, CountryList } from '@/utils/commonData';
...
import { AddressOneValidation, AddressTwoValidation, checkCreditCardValid, CleanPhoneNumber, EmailValidation, HouseNoValidation, isFieldRequired, LuhnCheckValidation, PhoneNoValidation, removeTabIndex } from '@/utils/common';
...
const BusinessCustomerInfoUpdateForm: React.FC<Props> = ({ setOpenDrawer, mode = 'create', refetchAPI }) => {
                ...
                <Box component="fieldset" sx={{
                    ...
                    <Grid container columnSpacing={2} alignItems={'center'} justifyContent={'space-between'}>
                        <Grid item xs={3} md={3} fontWeight={600} fontSize={14}>
                            <Typography variant='subtitle1' fontSize={14} >Search By Card Number <span dangerouslySetInnerHTML={{ __html: isFieldRequired(schema, 'CardNumber')}} ></span></Typography>
                        </Grid>
                        <Grid item xs={4} md={4}>
                            <TextFieldBox
...
export default BusinessCustomerInfoUpdateForm;