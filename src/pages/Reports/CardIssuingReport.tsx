...
export default function CardIssuingReport() {
  ...
  const { data, isLoading } = useQueryListData({
    queryKey: "fetchCardIssuingList",
    url: `${endpoint.getCardIssuingReport}`,
    config: {},
    payload: payload
  });
  ...
  const columns: GridColDef[] = [
    ...
    { field: 'NRC', headerName: 'NRC', flex: 1, minWidth: 170 },
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={12} md={3} lg={2} >
            <SelectBox
              ...
              value={filterItem.CardType}
              onChange={(value: any) => handleDataChanges("CardType", value)}
            />
          </Grid>
          <Grid item xs={12} sm={12} md={3} lg={2} >
            <YearMonthPicker
